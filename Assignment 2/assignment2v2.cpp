...
class Fiction: public Book{                            //class Fiction extends Book and inherits book's attributes
	string id;
...
int main(){
	...
	Horror sortH[100];                                           //to sort the above horror, poetry, and fiction arrays into descending lists
	Poetry sortP[100];
	Fiction sortF[100];
	...
	for(int i = 0; i < 100; i++){                               //repeat of above sort for poetry
		highest2 = -1;
		for(int j = 0; j < 100; j++){
	...
	for(int i = 0; i < 100; i++){                               //repeat of above sort for fiction
		highest3 = -1;
		for(int j = 0; j < 100; j++){
	...
	cout<<"Top 10 for Genre Fiction are:"<<endl;              //printing out first ten of sorted array because they are the highest rated ten
	for(int i = 0; i < 10; i++){
